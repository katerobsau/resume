...
tribble(
  ...
  "President of the Mathematics and Statistics Student Society (STAMPS)",
  "2015 -- 2016",
  "University of Melbourne",
  "Events run include: National Science Week Events, Careers Panel, Social Events"
  
) %>% 
   detailed_entries(with = with, when = when, where = where, why = why)
```
