...
# www: www.webpage.com
email: "kate.r.saunders@qut.edua.u"
twitter: katerobsau
github: katerobsau
# linkedin: linkedin
 ...
 * Primary research interests are statistical climatology and associated problems
 * Topics include; statistical post-processing, climate extremes, compound events and  quality control
 * University lecturer with a preference courses about probability and statistics
 * Postdoctoral research was in improving statistical post-processing methods for compound events forecasts
 * Postgraduate research was in extreme value theory with climate applications
...
tribble(
  ...
  "Brisbane, Australia", 
  "Jan 2021 - Present", 
  "Lecturer with courses including Statistical Data Analysis (MXN500) and Quantitative Methods in Science (SEB133)",
  
  "Lecturer (3 year fixed term contract)", 
  "Queensland University of Technology", 
  "Brisbane, Australia", 
  "Jan 2021 - Present", 
  "Lecturing responsibilities include: Unit coordination, and organising curriculum, teaching and assessment materials for the unit",
  
   "Lecturer (3 year fixed term contract)", 
  "Queensland University of Technology", 
  "Brisbane, Australia", 
  "Jan 2021 - Present", 
  "Research Interests: Statistical climatology, Statistical Post-processing, Compound Risk Assessment, Climate Extremes, Quality Control"
...
tribble(
  ...
  "Deflt, Netherlands", 
  "Oct. 2018 - Oct. 2020", 
  "Lecturer in Probability and Statistics for Aeronautical Engineers (WI2180LR-II)"
...
tribble(
  ...
  "Melbourne, Australia", 
  "Feb. 2012 - Feb. 2014", 
  "Research Interests: Natural Disaster Modelling, ie. Floods, Tsnumais, Sea Level Rise, Computational Fluid Dynamics"
) %>% 
  detailed_entries(degree, dates, uni, loc, details)
```
```{r}
...
"Primary Co-supervisors: Kate Saunders and Kirien Whan at KNMI, with University Co-Supervisor: Jason Frank",
"Utrecht University",
"Paper in submission for Quarterly Journal of the Royal Meteorlogical Society",
...
tribble(
 ~what_grant, ~ when_year, ~with_coapplicants, ~ where_fundingbody, ~ why_details,
  ...
  "Applicants: Dr. Boris Beranger (UNSW), Dr. Kate Saunders (TU Delft) and Dr. Alec Stephenson (CSIRO)",
  "ACEMS",
  "As corona prevents international travel this funding went into stasis",
 "Research Support Scheme ($15,000 AUD)", 
  "2020",
  "Applicants: Dr. Boris Beranger (UNSW), Dr. Kate Saunders (TU Delft) and Dr. Alec Stephenson (CSIRO)",
  "ACEMS",
  "This funding can now be used for domestric travel but rolling lockdowns have made this difficult"
) %>% 
...
tribble(
 ...
 "Finalist for the Harry Otten Prize in Meteorology",
 "European Meteorological Society",
 "1st prize: €25,500 ($40,000 AUD), 2nd/3rd prize: €5,000 ($8,000 AUD)",
 "2021",
 ...
 "1st prize: €25,500 ($40,000 AUD), 2nd/3rd prize: €5,000 ($8,000 AUD)",
 "2021",
 "Joint applicant with Dr. Kirien Whan at KNMI",
