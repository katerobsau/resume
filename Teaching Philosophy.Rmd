...
While this is indeed an ambitious but achievable goal, I am also \textbf{confident that I can contribute in other ways to the department via the mathematical teaching load}. This is evidenced by my past experience teaching many of the mathematics and statistics subjects that engineers are required to take at the University of Melbourne.

I also hope to be a \textbf{point of call within the department for help on statistical problems and guidance}. Helping others with their research questions forms an important part of contributing to my community and mentoring the next generation of researchers. 

# Supervison

This fellowship provides a great opportuntity to be involved in the supervision of students. In particular, I hope to work with the staff in the labs of Hydrological Processes and Managing Variability to leverage our joint knowledge to create exciting masters student projects. Ideally, this fellowship will also provide an opportuntity for me to gain experience co-supervisoring PhD students. As a recent graduate, I feel I have much to offer in the capacity of PhD co-supervisor and student mentor.

I have learnt from my past supervision experiences, around project scoping, producing tangible outcomes and balancing expectations. I hope to bring this awareness to future students I supervise. Past supervison experience includes helping students to; 

* Perform a sensitivity analysis when estimating tsunami inundation using a shallow water solver. This study was needed to address missing data within the input bathymetry in order to understand model uncertainty.
...
* I also have a joint masters project advertised with KNMI (Dutch Meteorlogical Institue) for a student to compare citizen science observations of wind gusts to verified observations. Verifying citizen data is incredibly useful for climate modelling and forecasting wind energy.
